...
include('../session.php');
  ...
  elseif ( isset($_POST['httpd-restart']) )
   {
     shell_exec("/var/www/html/script_/MANAGE_httpd restart");
     header("location: ../manage.php");
   }
  ...
  elseif ( isset($_POST['sys-addr']) )
   {
     ...
     shell_exec("/var/www/html/script_/MANAGE_addr changeaddr '$new_addr'");
     header("location: ../configure.php");
   }
  elseif ( isset($_POST['sys-gate']) )
   {
     $new_gate=$_POST['sys-gate'];
     shell_exec("/var/www/html/script_/MANAGE_addr changegate '$new_gate'");
     header("location: ../configure.php");
   }
