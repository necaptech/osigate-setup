...
include('../session.php');
  ...
  elseif ( isset($_POST['httpd-reload']) )
   {
     shell_exec("/var/www/html/ownpan/script_/MANAGE_httpd reload");
     header("location: ../manage.php");
   }
  ...
  elseif ( isset($_POST['sys-ssid']) ) /* && isset($_POST['sys-psk']) ) */
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/MANAGE_wifi setWIFI '$new_ssid' '$new_psk'");
     header("location: ../configure.php");
   }
  elseif ( isset($_POST['web-host']) )
   {
     $new_host=$_POST['web-host'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_webhost change '$new_host'");
     header("location: ../configure.php");
   }
  ...
  elseif ( isset($_POST['web-host-port']) )
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/MANAGE_webhostPort change '$new_hostPort'");
     header("location: ../configure.php");
   }
  ...
  elseif ( isset($_POST['additweb-host']) )
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/MANAGE_additwebhost change '$new_addithost'");
     header("location: ../configure.php");
   }
  elseif ( isset($_POST['additweb-host-port']) )
   {
     $new_addithostPort=$_POST['additweb-host-port'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_additwebhostPort change '$new_addithostPort'");
     header("location: ../configure.php");
   }
  ...
  elseif ( isset($_POST['application']) )
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/MANAGE_application set '$new_applic'");
     header("location: ../configure.php");
   }
  ...
  elseif ( isset($_POST['tSTALE']) )
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tSTALE change '$new_tSTALE'");
     header("location: ../sensorc2.php");
   }
  elseif ( isset($_POST['tCONST']) )
   {
     $new_tCONST=$_POST['tCONST'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tCONST change '$new_tCONST'");
     header("location: ../sensorc2.php");
   }
  ...
  elseif ( isset($_POST['contr-add']) )
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/CONTROLLERS_manage add '$value'");
     header("location: ../controllers.php");
   }
  elseif ( isset($_POST['contr-del']) )
   {
     $value=$_POST['contr-del'];
     shell_exec("/var/www/html/ownpan/script_/CONTROLLERS_manage del '$value'");
     header("location: ../controllers.php");
   }
  elseif ( isset($_POST['tron1']) && isset($_POST['troff1']) )
   {
     $value1=$_POST['tron1'];
     $value2=$_POST['troff1'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 1 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron2']) && isset($_POST['troff2']) )
   {
     $value1=$_POST['tron2'];
     $value2=$_POST['troff2'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 2 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron3']) && isset($_POST['troff3']) )
   {
     $value1=$_POST['tron3'];
     $value2=$_POST['troff3'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 3 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron4']) && isset($_POST['troff4']) )
   {
     $value1=$_POST['tron4'];
     $value2=$_POST['troff4'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 4 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron5']) && isset($_POST['troff5']) )
   {
     $value1=$_POST['tron5'];
     $value2=$_POST['troff5'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 5 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron6']) && isset($_POST['troff6']) )
   {
     $value1=$_POST['tron6'];
     $value2=$_POST['troff6'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 6 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron7']) && isset($_POST['troff7']) )
   {
     $value1=$_POST['tron7'];
     $value2=$_POST['troff7'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 7 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['tron8']) && isset($_POST['troff8']) )
   {
     $value1=$_POST['tron8'];
     $value2=$_POST['troff8'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_tr set 8 '$value1' '$value2'");
     header("location: ../controllers.php");
   }
  ...
  elseif ( isset($_POST['exch-ip']) )
   {
     ...
     shell_exec("/var/www/html/ownpan/script_/MANAGE_exchange change '$new_ip'");
     header("location: ../controllers.php");
   }
  elseif ( isset($_POST['queue_name']) )
   {
     $new_q=$_POST['queue_name'];
     shell_exec("/var/www/html/ownpan/script_/MANAGE_queue change '$new_q'");
     header("location: ../controllers.php");
   }
  ...
  elseif (isset($_POST['mysql-query']))
   {
     ...
     elseif ( $new_query == "3a" )
       ...
       $cid=$_POST['cli11'];
       $qty=$_POST['qty11'];
       $getres=shell_exec("/var/www/html/ownpan/script_/STATISTIC_mysql query '$new_query' '$cid' '$qty'");
       }
