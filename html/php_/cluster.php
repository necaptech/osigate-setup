...
?>
   ...
   <form action="subphp_/cluster.php" method="post">
     <fieldset>
       <legend><b>Cluster enabled: <?php $output=shell_exec("/var/www/html/script_/CLUSTER_manage show enabled"); print_r($output); ?></b></legend><br>
   ...
   <form action="subphp_/cluster.php" method="post">
     <fieldset>
       <legend><b>My Cluster role: <?php $output=shell_exec("/var/www/html/script_/CLUSTER_manage show role"); print_r($output); ?></b></legend><br>
   ...
   <form action="subphp_/cluster.php" method="post">
     <fieldset>
       <legend><b>Operational Mode: <?php $output=shell_exec("/var/www/html/script_/CLUSTER_manage show mode"); print_r($output); ?></b></legend><br>
   ...
   <form action="subphp_/cluster.php" method="post">
     <fieldset>
       <legend><b>Deadline Timeout: <?php $output=shell_exec("/var/www/html/script_/CLUSTER_manage show deadline"); print_r($output); ?></b></legend><br>
    ...
    <div id="login">
      <form action="subphp_/cluster.php" method="post">
      <b>Companion IPv4: <i><?php $output=shell_exec("/var/www/html/script_/CLUSTER_manage show companion"); print_r($output); ?></i></b>
